...
import { Command_AddRepo } from './plugin-components/commands/repos/add-repo';
import { Command_OpenRepo } from './plugin-components/commands/repos/open-repo';
import { Command_GetRepoCdCmd } from './plugin-components/commands/repos/get-cd-repo-cmd';
import { Command_GetOpenRepoCmd } from './plugin-components/commands/repos/get-open-repo-cmd';
import { Command_GetCreateRepoCmd } from './plugin-components/commands/repos/get-create-repo-cmd';
import { Command_FindRepo } from './plugin-components/commands/repos/find-repo';
